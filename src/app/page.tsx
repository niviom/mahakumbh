...
const goldMonarchNetworkworth = "/assets/sponsors/sponsor-monarch-networkworth.png";
...
const Divider = () => (
  <div className="flex items-center justify-center gap-3 my-6">
    ...
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className="text-[oklch(0.82_0.14_82)]">
      <path
...
const CornerOrnament = ({ className = "" }: { className?: string }) => (
  ...
  >
    ...
    <path d="M20 30 Q30 20 40 30 Q30 25 20 30 Z" fill="currentColor" opacity="0.7" />
  </svg>
);
  ...
  const universe: GalaxyZone[] = [
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/899540984209746ee547c9515a704e4488779da8.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.85 0.14 25) 0%, oklch(0.6 0.18 20) 50%, oklch(0.35 0.12 15) 100%)",
    ...
    },
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/a0551faa22d7250766d311fff56b880bb0e741c5.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.88 0.13 145) 0%, oklch(0.62 0.16 140) 50%, oklch(0.35 0.1 135) 100%)",
    ...
    },
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/8abe897a9a92af366674f8dac033f1dcfaeb0268.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.85 0.14 300) 0%, oklch(0.6 0.16 295) 50%, oklch(0.35 0.1 290) 100%)",
    ...
    },
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/ad983ef71b31fca03a481dd51669d4c5e49eaab5.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.85 0.12 245) 0%, oklch(0.58 0.14 240) 50%, oklch(0.32 0.09 235) 100%)",
    ...
    },
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/c0bb06ae661b0e8cbfd74c667e37db7c83c18088.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.88 0.13 75) 0%, oklch(0.65 0.15 70) 50%, oklch(0.38 0.1 65) 100%)",
    ...
    },
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/9942a90a5973a2b5ee4739ff8ea3fab3cfd45149.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.85 0.11 185) 0%, oklch(0.58 0.13 180) 50%, oklch(0.32 0.08 175) 100%)",
    ...
    },
    {
      ...
      poster: suitesPoster,
      video: "https://embed-ssl.wistia.com/deliveries/fa2dd17a6fabe7a2f7bb42e0e74a2c1a7f1f9256.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.85 0.12 340) 0%, oklch(0.6 0.14 335) 50%, oklch(0.35 0.09 330) 100%)",
    ...
    },
    {
      ...
      poster: aiPoster,
      video: aiCenterVideo,
      color: "radial-gradient(circle at 35% 35%, oklch(0.82 0.14 270) 0%, oklch(0.55 0.16 265) 50%, oklch(0.3 0.1 260) 100%)",
    ...
    },
    {
      ...
      video: "https://embed-ssl.wistia.com/deliveries/35e0e5bc89e5db01be931198eed7534be94355a4.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.87 0.13 45) 0%, oklch(0.63 0.15 40) 50%, oklch(0.37 0.1 35) 100%)",
    ...
    },
    {
      ...
      poster: honourPoster,
      video: "https://embed-ssl.wistia.com/deliveries/0dce3a5fdad177e4601c90ede6b2c49ff6797975.bin",
      color: "radial-gradient(circle at 35% 35%, oklch(0.9 0.02 250) 0%, oklch(0.7 0.04 245) 50%, oklch(0.45 0.03 240) 100%)",
          ...
          <Reveal className="mt-20 ornate-frame rounded-sm p-8 sm:p-12 bg-[oklch(0.18_0.06_265/0.7)] backdrop-blur text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8 text-left">
              {[
                ...
                <div key={s.v} className="border-l border-[oklch(0.72_0.14_78/0.4)] pl-4">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          <Reveal>
            ...
            <p className="text-[oklch(0.85_0.03_85)] leading-relaxed">
              An opulent gathering of India&apos;s boldest founders, investors and visionaries —
              staged across <span className="text-[oklch(0.92_0.15_88)]">2,50,000 sqft</span> of
              Mumbai&apos;s most storied ground.
            </p>
      ...
      <section id="support" className="relative py-16 sm:py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <Reveal className="relative ornate-frame rounded-sm p-8 sm:p-12 bg-[oklch(0.18_0.06_265/0.7)] backdrop-blur">
            ...
            <p className="text-xs tracking-[0.4em] uppercase text-[oklch(0.82_0.14_82)]">Need Assistance?</p>
            <h2 className="font-display text-3xl sm:text-5xl mt-4 text-gold">Delegate Support</h2>
            <Divider />
            <p className="text-[oklch(0.85_0.03_85)] max-w-2xl mx-auto mb-8">
              For queries on registration, invites, accommodation or travel — reach out to our dedicated support team.
            </p>
            <a
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 bg-gradient-to-r from-[oklch(0.14_0.05_265)] via-[oklch(0.22_0.08_265)] to-[oklch(0.14_0.05_265)] border-t border-[oklch(0.72_0.14_78/0.4)] shadow-[0_-10px_30px_-15px_oklch(0_0_0/0.8)]">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 px-4 sm:px-6 py-3">
          <div className="hidden sm:block">
            <p className="text-[10px] tracking-[0.3em] uppercase text-[oklch(0.82_0.14_82)]">14 – 16 August 2026 · Mumbai</p>
            <p className="font-display text-lg text-gold leading-tight">Pagariya JBN Mahakumbh 2026</p>
          </div>
