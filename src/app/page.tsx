            ...
            <Reveal delay={250}>
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-8 py-3 w-full sm:w-auto sm:min-w-[14rem] border border-gold text-[oklch(0.9_0.1_85)] rounded-sm font-medium tracking-wide hover:bg-[oklch(0.72_0.14_78/0.1)] transition"
                >
                  <svg
                    width="18"
                    height="18"
